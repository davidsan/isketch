# This is module is a fork of HTML::HashTable written by 
# Kirrily "Skud" Robert <skud@cpan.org>.
# It was edited to add Bootstrap's classes to the table tag.
# Last edit on 24/11/2013 by David San <david.san@etu.upmc.fr>
...
sub open_table {
	...
	$HTML::HashTable::output .= $tsref->{BORDER} ? "<table class='table table-bordered table-condensed table-striped' border=1>\n" : "<table border=0>\n";
}
